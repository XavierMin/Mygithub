...
//			m5311_send_cmd("AT+MQTTPUB=$dp,1,0,0,31,03001C7b2254223a31312e312c2248223a35352e352c2249223a33332e337d","OK",500);
		
			sprintf((char *)send_dat, "{\"T\":%3.1f,\"H\":%3.1f,\"I\":%3.1f}", temperature, humidity, result_lx);
			printf( "\r\n" );
			printf( "[INFO]*****************************************\r\n" );
			printf( "[INFO]Coap send-->%s\r\n", send_dat);
			nb_mqtt_report(send_dat, strlen(send_dat));
